      ...
      const INDUSTRY_ICONS = {
        ...
        Packaging: "package",
        Gensets: "zap",
        "UPS and Inverters": "battery",
        Elevators: "arrow-up-down",
      ...
      function generateMockData(industry, index) {
        ...
        const kpis = Array.from({ length: 6 }).map((_, i) => {
          ...
          const val = isPercentage
            ? (random(i) * 100).toFixed(1) + "%"
            : Math.floor(random(i) * 5000 + 100).toLocaleString();
          return {
            label: `${industry} Metric ${i + 1}`,
            val,
            delta:
              (random(i + 10) > 0.5 ? "↑ " : "↓ ") +
              (random(i + 20) * 5 + 0.1).toFixed(1) +
              "%",
          ...
          if (type === 0) {
            return {
              ...
              data: [
                ...
                {
                  name: "Feb",
                  value: Math.floor(random(i * 10 + 1) * 100) + 20,
                },
                {
                  name: "Mar",
                  value: Math.floor(random(i * 10 + 2) * 100) + 20,
                },
                {
                  name: "Apr",
                  value: Math.floor(random(i * 10 + 3) * 100) + 20,
                },
                {
                  name: "May",
                  value: Math.floor(random(i * 10 + 4) * 100) + 20,
                },
                {
                  name: "Jun",
                  value: Math.floor(random(i * 10 + 5) * 100) + 20,
                },
              ],
            };
          } else if (type === 1) {
            return {
              ...
              data: [
                ...
                {
                  name: "Q2",
                  value: Math.floor(random(i * 10 + 1) * 500) + 100,
                },
                {
                  name: "Q3",
                  value: Math.floor(random(i * 10 + 2) * 500) + 100,
                },
                {
                  name: "Q4",
                  value: Math.floor(random(i * 10 + 3) * 500) + 100,
                },
              ],
            };
          } else if (type === 2) {
            return {
              ...
              data: [
                {
                  name: "Segment A",
                  value: Math.floor(random(i * 10) * 100) + 10,
                },
                {
                  name: "Segment B",
                  value: Math.floor(random(i * 10 + 1) * 100) + 10,
                },
                {
                  name: "Segment C",
                  value: Math.floor(random(i * 10 + 2) * 100) + 10,
                },
                {
                  name: "Segment D",
                  value: Math.floor(random(i * 10 + 3) * 100) + 10,
                },
              ],
            };
          } else {
            return {
              ...
              data: [
                {
                  subject: "Metric 1",
                  A: Math.floor(random(i * 10) * 80) + 20,
                  fullMark: 100,
                },
                {
                  subject: "Metric 2",
                  A: Math.floor(random(i * 10 + 1) * 80) + 20,
                  fullMark: 100,
                },
                {
                  subject: "Metric 3",
                  A: Math.floor(random(i * 10 + 2) * 80) + 20,
                  fullMark: 100,
                },
                {
                  subject: "Metric 4",
                  A: Math.floor(random(i * 10 + 3) * 80) + 20,
                  fullMark: 100,
                },
                {
                  subject: "Metric 5",
                  A: Math.floor(random(i * 10 + 4) * 80) + 20,
                  fullMark: 100,
                },
              ],
            };
        ...
        return {
          ...
          table: {
            ...
            rows: [
              [
                "Metric A",
                Math.floor(random(60) * 1000).toString(),
                "+5%",
                "Optimal",
              ],
              [
                "Metric B",
                Math.floor(random(61) * 1000).toString(),
                "+2%",
                "Good",
              ],
              [
                "Metric C",
                Math.floor(random(62) * 1000).toString(),
                "-1%",
                "Monitor",
              ],
              [
                "Metric D",
                Math.floor(random(63) * 1000).toString(),
                "+3%",
                "Good",
              ],
            ],
      ...
      const dashboardsByIndustry = industriesList.reduce(
        (acc, industry, index) => {
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        accordionItems.forEach((item) => {
          item.addEventListener("click", () => {
            ...
            accordionItems.forEach((i) => {
              ...
              i.querySelector(".accordion-icon").style.transform =
                "rotate(0deg)";
            });
        ...
        // AI Lab Logic
        document
          .getElementById("launch-lab-btn")
          .addEventListener("click", () => launchLab(industriesList[0]));
        document
          .getElementById("close-lab-btn")
          .addEventListener("click", () => {
            document
              .getElementById("ai-lab-landing")
              .classList.remove("hidden");
            document.getElementById("ai-lab-dashboard").classList.add("hidden");
            document
              .getElementById("ai-lab-dashboard")
      ...
      window.selectIndustry = function (industry) {
        ...
        const activeBtn = document.getElementById(
          `sidebar-btn-${industry.replace(/\s+/g, "-")}`,
        );
        if (activeBtn) {
        ...
        data.charts.forEach((chart, i) => {
          ...
          let config = {
            ...
            options: {
              ...
              scales:
                chart.type === "pie" || chart.type === "radar"
                  ? {}
                  : {
                      x: {
                        grid: { display: false },
